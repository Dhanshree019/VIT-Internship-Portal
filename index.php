...
?>
<main>
  <h3 class="text-center p-3" style="color:orange;">List of Internships</h3>
    ...
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-footer">
          <a href="internship.php?internship=<?=$internship['id'];?>" class="btn btn-success btn-orange waves-effect z-depth-0">View Details</a>
        </div>
      </div>
    </div>
    <?php endwhile;?>
