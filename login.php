			...
			<div class="card-body">
				...
				<div class="p-3">
					...
					<div class="float-right">
						<p class=""><a href="splash.php" style="color:orange;">Go back-></a></p>
					</div>
				</div>
			</div>			
			<div class="card-footer">
				<div class="float-right">
					<button type="submit" name="login" class="btn btn-orange" style="border-radius: 10em;background: #1c2a48">Login</button>
				</div>
			</div>
		</form>
		<?php 
